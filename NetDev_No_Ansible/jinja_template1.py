#!/user/bin/env python
# For reference.  See jinja_template3.py for how to dry out code. This codes works.
# jinja_template3.py prints the same data but pulls out the jinja code to external templates.
